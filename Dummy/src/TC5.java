...
public class TC5 {
		...
		public static void main(String[] args) throws InterruptedException {
			 ...
			 System.setProperty("webdriver.chrome.driver", "C:\\Users\\PC\\New Workspace\\Dummy\\exe2files\\chromedriver.exe");
				...
				driver.findElement(By.xpath("//strong[contains(text(),'Evaluated Leads')]/parent::div[@class='col']//following-sibling::div[@class='col text-right']/button[text()=' Invoice ']/fa-icon")).click();
